...
public interface StringList {
    ...
    // Ваша задача: написать свою реализацию ArrayList.
    // В данной задаче он должен работать только со строками.
    ...
    // которые описаны в интерфейсе. Если в какой-то из методов в качестве параметра приходит null,
